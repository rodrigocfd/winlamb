...
public:
	...
	explicit device_context(const hwnd_base* wnd, HDC hDC = nullptr) noexcept
...
public:
	...
	explicit device_context_simple(const hwnd_base* wnd) noexcept
...
public:
	...
	explicit device_context_buffered(const hwnd_base* wnd) noexcept
