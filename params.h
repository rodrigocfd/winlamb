...
#define WINLAMB_EMPTYWM(sname) \
	struct sname : public params { \
		sname(params p) : params(p) { } \
	}

	struct activate : public params {
		activate(params p) : params(p) { }
	...
	struct askcbformatname : public params {
		askcbformatname(params p) : params(p) { }
	...
	struct copydata : public params {
		copydata(params p) : params(p) { }
		COPYDATASTRUCT& copydatastruct() const { return *reinterpret_cast<COPYDATASTRUCT*>(this->lParam); }
	};
	struct create : public params {
		create(params p) : params(p) { }
		CREATESTRUCT& createstruct() const { return *reinterpret_cast<CREATESTRUCT*>(this->lParam); }
	};

	struct ctlcolorbtn : public params {
		ctlcolorbtn(params p) : params(p) { }
		HDC  hdc() const  { return reinterpret_cast<HDC>(this->wParam); }
		HWND hctl() const { return reinterpret_cast<HWND>(this->lParam); }
	};
	struct ctlcolordlg       : public ctlcolorbtn { ctlcolordlg(params p)       : ctlcolorbtn(p) { } };
	struct ctlcoloredit      : public ctlcolorbtn { ctlcoloredit(params p)      : ctlcolorbtn(p) { } };
	struct ctlcolorlistbox   : public ctlcolorbtn { ctlcolorlistbox(params p)   : ctlcolorbtn(p) { } };
	struct ctlcolorscrollbar : public ctlcolorbtn { ctlcolorscrollbar(params p) : ctlcolorbtn(p) { } };
	struct ctlcolorstatic    : public ctlcolorbtn { ctlcolorstatic(params p)    : ctlcolorbtn(p) { } };

	struct deadchar : public params {
		deadchar(params p) : params(p) { }
		WORD char_code() const           { return static_cast<WORD>(this->wParam); }
		WORD repeat_count() const        { return LOWORD(this->lParam); }
		BYTE scan_code() const           { return LOBYTE(HIWORD(this->lParam)); }
		bool is_extended_key() const     { return (this->lParam >> 24) & 1; }
	...
	struct displaychange : public params {
		displaychange(params p) : params(p) { }
	...
	struct vscroll : public hscroll { vscroll(params p) : hscroll(p) { } };

	struct hscrollclipboard : public params {
		hscrollclipboard(params p) : params(p) { }
	...
	struct inputlangchange : public params {
		inputlangchange(params p) : params(p) { }
	...
	struct inputlangchangerequest : public params {
		inputlangchangerequest(params p) : params(p) { }
	...
	struct lbuttondown   : public lbuttondblclk { lbuttondown(params p)   : lbuttondblclk(p) { } };
	struct lbuttonup     : public lbuttondblclk { lbuttonup(params p)     : lbuttondblclk(p) { } };
	struct mbuttondblclk : public lbuttondblclk { mbuttondblclk(params p) : lbuttondblclk(p) { } };
	struct mbuttondown   : public lbuttondblclk { mbuttondown(params p)   : lbuttondblclk(p) { } };
	struct mbuttonup     : public lbuttondblclk { mbuttonup(params p)     : lbuttondblclk(p) { } };
	struct mousehover    : public lbuttondblclk { mousehover(params p)    : lbuttondblclk(p) { } };
	struct mousemove     : public lbuttondblclk { mousemove(params p)     : lbuttondblclk(p) { } };
	struct rbuttondblclk : public lbuttondblclk { rbuttondblclk(params p) : lbuttondblclk(p) { } };
	struct rbuttondown   : public lbuttondblclk { rbuttondown(params p)   : lbuttondblclk(p) { } };
	struct rbuttonup     : public lbuttondblclk { rbuttonup(params p)     : lbuttondblclk(p) { } };

	struct mdiactivate : public params {
		mdiactivate(params p) : params(p) { }
	...
	struct mouseactivate : public params {
		mouseactivate(params p) : params(p) { }
	...
	struct nccreate : public params {
		nccreate(params p) : params(p) { }
		CREATESTRUCT& createstruct() const { return *reinterpret_cast<CREATESTRUCT*>(this->lParam); }
	};
	WINLAMB_EMPTYWM(ncdestroy);
	struct nchittest : public params {
		nchittest(params p) : params(p) { }
		POINT pos() const { return { GET_X_LPARAM(this->lParam), GET_Y_LPARAM(this->lParam) }; }
	};

	struct nclbuttondblclk : public params {
		nclbuttondblclk(params p) : params(p) { }
		short hit_test_code() const { return static_cast<short>(this->wParam); }
		POINT pos() const           { return { GET_X_LPARAM(this->lParam), GET_Y_LPARAM(this->lParam) }; }
	};
	struct nclbuttondown   : public nclbuttondblclk { nclbuttondown(params p)   : nclbuttondblclk(p) { } };
	struct nclbuttonup     : public nclbuttondblclk { nclbuttonup(params p)     : nclbuttondblclk(p) { } };
	struct ncmbuttondblclk : public nclbuttondblclk { ncmbuttondblclk(params p) : nclbuttondblclk(p) { } };
	struct ncmbuttondown   : public nclbuttondblclk { ncmbuttondown(params p)   : nclbuttondblclk(p) { } };
	struct ncmbuttonup     : public nclbuttondblclk { ncmbuttonup(params p)     : nclbuttondblclk(p) { } };
	struct ncmousemove     : public nclbuttondblclk { ncmousemove(params p)     : nclbuttondblclk(p) { } };
	struct ncrbuttondblclk : public nclbuttondblclk { ncrbuttondblclk(params p) : nclbuttondblclk(p) { } };
	struct ncrbuttondown   : public nclbuttondblclk { ncrbuttondown(params p)   : nclbuttondblclk(p) { } };
	struct ncrbuttonup     : public nclbuttondblclk { ncrbuttonup(params p)     : nclbuttondblclk(p) { } };

	struct ncpaint : public params {
		ncpaint(params p) : params(p) { }
		HRGN hrgn() const { return reinterpret_cast<HRGN>(this->wParam); }
	};
	struct nextdlgctl : public params {
		nextdlgctl(params p) : params(p) { }
	...
	struct paintclipboard : public params {
		paintclipboard(params p) : params(p) { }
		HWND               clipboard_viewer() const { return reinterpret_cast<HWND>(this->wParam); }
	...
	struct powerbroadcast : public params {
		powerbroadcast(params p) : params(p) { }
	...
	struct rasdialevent : public params {
		rasdialevent(params p) : params(p) { }
	...
	struct spoolerstatus : public params {
		spoolerstatus(params p) : params(p) { }
	...
	struct stylechanged : public params {
		stylechanged(params p) : params(p) { }
	...
	struct stylechanging : public params {
		stylechanging(params p) : params(p) { }
		bool               is_style() const    { return (this->wParam & GWL_STYLE) != 0; }
		bool               is_ex_style() const { return (this->wParam & GWL_EXSTYLE) != 0; }
		const STYLESTRUCT& stylestruct() const { return *reinterpret_cast<const STYLESTRUCT*>(this->lParam); }
	};
	struct syschar : public params {
		syschar(params p) : params(p) { }
		WORD char_code() const           { return static_cast<WORD>(this->wParam); }
		WORD repeat_count() const        { return LOWORD(this->lParam); }
		BYTE scan_code() const           { return LOBYTE(HIWORD(this->lParam)); }
		bool is_extended_key() const     { return (this->lParam >> 24) & 1; }
